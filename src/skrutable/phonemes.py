...
SLP_voiced_consonants = ['g','G','N','j','J','Y','q','Q','R','d','D','n','b','B','m','y','r','l','v','L','h']
...
SLP_chars = ( [ c for c in Roman_upper if c not in ['V','Z'] ]
        + Roman_lower + ['~'] )

IAST_chars = ( [c for c in Roman_lower if c not in ['f','q','w','x','z'] ]
        + ['ñ','ā','ī','ś','ū','ḍ','ḥ','ḷ','ḹ','ḻ','ṃ','ṅ','ṇ','ṛ','ṝ','ṣ','ṭ','ẖ','ḫ','ï','ü','ĕ','ŏ']
